...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('gebruiker_has_resultaat', function (Blueprint $table) {
            // Controleer of de foreign key en kolom bestaan voordat je ze verwijdert
            if (Schema::hasColumn('gebruiker_has_resultaat', 'Gebruiker_idGebruiker')) {
            ...
            if (!Schema::hasColumn('gebruiker_has_resultaat', 'user_id')) {
